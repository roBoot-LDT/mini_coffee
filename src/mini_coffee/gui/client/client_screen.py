...
class ClientScreen(QWidget):
    ...
    def create_icecream_screen(self):
        ...
        vanilla_btn.setMinimumSize(225, 350)
        vanilla_btn.setMaximumSize(325, 600)
        ...
        mix_btn.setMinimumSize(225, 350)
        mix_btn.setMaximumSize(325, 600)
        ...
        chocolate_btn.setMinimumSize(225, 350)
        chocolate_btn.setMaximumSize(325, 600)
    ...
    def showEvent(self, event):
        ...
        self.move(screen_geometry.x() + half_width+ 150, screen_geometry.y()-50)
