...
class SettingsWindow(QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.lTime=QLineEdit()
        self.mTime=QLineEdit()
        self.rTime=QLineEdit()
        self.lTime=QLineEdit()
        self.disS = QLineEdit()
        self.disM = QLineEdit()
        ...
        self._create_input_field(device_layout, "Time L Ice:", self.lTime)
        self._create_input_field(device_layout, "Time M Ice:", self.mTime)
        self._create_input_field(device_layout, "Time R Ice:", self.rTime)
